...
<!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">5S Đợt đánh giá
                        <small>Sửa: {{ $campaign->name }}</small>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
                <div class="col-lg-12" style="padding-bottom:120px">
                    ...
                    <form action="admin/fives/campaign/edit/{{$campaign->id}}" method="POST" enctype="multipart/form-data">
