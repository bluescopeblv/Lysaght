<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/maintenance/danhsach"><i class="fa fa-bar-chart-o fa-fw"></i> Maintenance<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/maintenance/danhsach">Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/maintenance/them">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/prel3/danhsachwc">WC | Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/prel3/themwc">WC | Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="admin/activity"><i class="fa fa-bar-chart-o fa-fw"></i> ACTIVITY<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/activity">Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/activity/add">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
