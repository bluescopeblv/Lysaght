    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-body">
                <span class="tieude">LOGISTIC - CHỈNH SỬA KẾ HOẠCH</span>
...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
                ...
                @endif
                <form action="delivery2/logistic/edit/{{$thongtinxe->id}}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="form-body">
                        <h4>Dự án:  <span style="color: blue">{{$thongtinxe->khachhang}}</span></h4>
                        <hr>
