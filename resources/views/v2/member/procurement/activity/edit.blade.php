    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-body">
                <span class="tieude">ROS - EDIT <span style="color: green">{{ $product->name }}</span></span>
                    ...
                    <div class="form-body">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Bao ni lông (200m/1000m2)</label>
                                        <input type="text" name="covering_nylon" class="form-control form-control-danger" placeholder="Bao ni lông" value="{{ $product->covering_nylon }}">
                                    </div>    
                                </div>
                            </div>
                        </div>
