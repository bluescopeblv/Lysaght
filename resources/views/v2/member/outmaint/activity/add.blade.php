    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-body">
                <span class="tieude">OUTSOURCE MAINTENANCE - THÊM MỚI</span>
...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
                ...
                @endif
                <form action="outmaint/activity/add" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="datetime" name="date" class="form-control form-control-danger" placeholder="yyyy-mm-dd" value="{{date('Y-m-d')}}">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-10">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="content" class="form-control form-control-danger" placeholder="Nhập nội dung bảo trì" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="datetime" name="solution_date" class="form-control form-control-danger" placeholder="yyyy-mm-dd" value="{{date('Y-m-d')}}">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-10">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="solution" class="form-control form-control-danger" placeholder="Đã khắc phục, sửa chữa như thế nào" value="">
                                        </div>
                                    </div>
                                    <!--/row-->
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <div class="form-group has-danger">
                                        ...
                                        <input type="text" name="note" class="form-control form-control-danger" placeholder="Note" value="">
                                    </div>
                                </div>
