    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="dashboard/safety/add" method="post">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="LTI" name="LTI" class="form-control" placeholder="LTI Date">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-3">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="text" id="MTI" name="MTI" class="form-control form-control-danger" placeholder="MTI">
                                </div>
                            </div>
                            <!--/span-->
