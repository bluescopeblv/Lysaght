                        ...
                        <tr>
                            ...
                            <td>
                                <span class="label label-warning">
                                    <a href="delivery/baove/edit/{{$val->id}}"><span class="glyphicon glyphicon-edit">Sửa</span></a>
                                </span><span>  </span>
                                
                                <span class="label label-danger">
                                    <a href="delivery/baove/delete/{{$val->id}}"><span class="glyphicon glyphicon-remove-sign">Xóa</span></a>
                                </span>
                            </td>
                        </tr>
                        @endforeach
