                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="total_employees" class="form-control" placeholder="Tổng nhân viên" value="{{ $hr->total_employees }}">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-3">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="text" name="female_employees" class="form-control form-control-danger" placeholder="Số nhân viên nữ" value="{{ $hr->female_employees }}">
                                </div>
                            </div>
                            <!--/span-->
