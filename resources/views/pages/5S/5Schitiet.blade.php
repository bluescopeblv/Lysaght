    	...
    	<div class="row carousel-holder">
            ...
            <div class="col-md-20">
                <div class="panel panel-info">
				  	<div class="panel-heading">CHI TIẾT ID:  {{$detail->id}} </div>
				  	<div class="panel-body">
                        ...
                        @endif
				  		<!-- REPORT KHIẾM KHUYẾT -->
					    	<form action="fives/chitiet/{{$detail->id}}" method="post">
			                    <input type="hidden" name="_token" value="{{csrf_token()}}">
			                    <div class="col-md-4">
				                    <div class="form-group">
				                        <label>Workcenter</label>
				                        <input class="form-control" type="text" name="workcenter" value="{{$detail->workcenter}}" disabled/>
				                    </div>
				                </div>
				                <div class="col-md-8">
				                    <div class="form-group">
				                        <label>Mô tả khiếm khuyết</label>
				                        <input class="form-control" name="mota" value="{{$detail->mota}}" disabled />
				                    </div>
				                </div>
				                <div class="col-md-8">
				                    <div class="form-group">
				                        <label>Phương pháp khắc phục*</label>
