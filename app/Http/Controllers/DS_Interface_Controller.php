...
class DS_Interface_Controller extends Controller
{
    ...
    public function getInterface1()
    {
        ...
        $chart->dataset('Actual', 'bar', [59,60,53,60,59,60,57,58, 57, 59])->color('red')->backgroundColor('pink');
        ...
        $chart2->dataset('Actual', 'bar', [87,84,76,80,79,78, 76, 77, 75, 75])->color('green')->backgroundColor('pink');
