...
class DS_HR_Controller extends Controller
{
    ...
    // V2
    //-----------------------------------
    public function get_List_2()
    {
        $hr = DS_HR::orderBy('id','DESC')->get();
        return view('v2.member.dashboard.hr.list', compact('hr'));
    }

    public function get_Add_2()
    {
        return view('v2.member.dashboard.hr.add');
    }

    public function post_Add_2(Request $request)
    {
        $this->validate($request,[
            'total_employees' => 'required',
            'female_employees'=>'required',
    ...
    public function get_Edit_2($id)
    {
        $hr = DS_HR::find($id);
        return view('v2.member.dashboard.hr.edit',compact('hr'));
    }

    public function post_Edit_2($id, Request $request)
    {
        $this->validate($request,[
            'total_employees' => 'required',
            'female_employees'=>'required',
    ...
    public function get_Delete_2($id)
    {
        $hr = DS_HR::find($id);
        $hr->delete();
        return redirect()->back()->with('thongbao','Delete successfully');
